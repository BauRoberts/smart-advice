...
// Wrapper que expone la función toast directamente
export function toast({
  ...
  // Simular un toast básico sin necesidad de un estado global
  // En una aplicación real, deberías usar un contexto o zustand para esto
  return {
